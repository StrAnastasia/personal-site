  ...
  resources: {
    ENG: {
      translation: {
        ...
        CVPhone: 'Phone: +995 59 101 53 56',
    ...
    RUS: {
      translation: {
        ...
        CVPhone: 'Телефон: +995 59 101 53 56',
